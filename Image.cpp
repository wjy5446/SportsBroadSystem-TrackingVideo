...
bool AddResultInDoc(int nW, int nH, int nPosX, int nPosY, BYTE** ImageR, BYTE** ImageG, BYTE** ImageB, CPoint target1, CPoint target2, CPoint target3, int frame)
{
	CMainFrame *pMain = (CMainFrame *)AfxGetMainWnd();
	CChildFrame *pChild = (CChildFrame *)pMain->MDIGetActive();
	...
	return pView->AddResultInDoc(nW, nH, nPosX, nPosY, ImageR, ImageG, ImageB, target1, target2, target3, frame);
}

bool AddZoom1InDoc(int nW, int nH, int nPosX, int nPosY, BYTE* ImageColor, int frame)
{
	CMainFrame *pMain = (CMainFrame *)AfxGetMainWnd();
	CChildFrame *pChild = (CChildFrame *)pMain->MDIGetActive();
	...
	return pView->AddZoom1InDoc(nW, nH, nPosX, nPosY, ImageColor, frame);
}

bool AddZoom2InDoc(int nW, int nH, int nPosX, int nPosY, BYTE* ImageColor, int frame)
{
	CMainFrame *pMain = (CMainFrame *)AfxGetMainWnd();
	CChildFrame *pChild = (CChildFrame *)pMain->MDIGetActive();
	...
	return pView->AddZoom2InDoc(nW, nH, nPosX, nPosY, ImageColor, frame);
}

bool AddZoom3InDoc(int nW, int nH, int nPosX, int nPosY, BYTE* ImageColor, int frame)
{
	CMainFrame *pMain = (CMainFrame *)AfxGetMainWnd();
	CChildFrame *pChild = (CChildFrame *)pMain->MDIGetActive();
	...
	return pView->AddZoom3InDoc(nW, nH, nPosX, nPosY, ImageColor, frame);
}
